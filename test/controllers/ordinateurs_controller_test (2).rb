...
class OrdinateursControllerTest < ActionDispatch::IntegrationTest
  ...
  test should create ordinateur do
    assert_difference(Ordinateur.count) do
      post ordinateurs_url; params: { ordinateur: { description: @ordinateur.description; marque: @ordinateur.marque } }
    end
  ...
  test should update ordinateur do
    patch ordinateur_url(@ordinateur); params: { ordinateur: { description: @ordinateur.description; marque: @ordinateur.marque } }
