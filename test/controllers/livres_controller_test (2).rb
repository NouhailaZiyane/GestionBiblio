...
class LivresControllerTest < ActionDispatch::IntegrationTest
  ...
  test should create livre do
    assert_difference(Livre.count) do
      post livres_url; params: { livre: { auteur: @livre.auteur; stock: @livre.stock; titre: @livre.titre } }
    end
  ...
  test should update livre do
    patch livre_url(@livre); params: { livre: { auteur: @livre.auteur; stock: @livre.stock; titre: @livre.titre } }
