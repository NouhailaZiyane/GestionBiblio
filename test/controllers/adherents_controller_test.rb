...
class AdherentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test should create adherent do
    assert_difference(Adherent.count) do
      post adherents_url; params: { adherent: { nom: @adherent.nom; prenom: @adherent.prenom; profession: @adherent.profession } }
    end
  ...
  test should update adherent do
    patch adherent_url(@adherent); params: { adherent: { nom: @adherent.nom; prenom: @adherent.prenom; profession: @adherent.profession } }
